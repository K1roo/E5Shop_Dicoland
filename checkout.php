...
if(isset($_POST['order_btn'])){
   ...
   $address = mysqli_real_escape_string($conn, 'appartement '. $_POST['flat'].' '. $_POST['street'].', '. $_POST['city'].', '. $_POST['country'].' - '. $_POST['pin_code']);
...
<div class="heading">
   <h3>checkout</h3>
   <p> <a href="home.php">Page d'accueil </a> / checkout </p>
</div>
