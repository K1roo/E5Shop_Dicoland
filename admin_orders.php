...
if(isset($_POST['update_order'])){
   ...
   $message[] = 'Mis à jour bien enregistrer';
      ...
      <div class="box">
         ...
         <form action="" method="post">
            ...
            <select name="update_payment">
               ...
               <option value="completed">Commande terminée</option>
            </select>
            <input type="submit" value="mettre à jour" name="update_order" class="option-btn">
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id']; ?>" onclick="return confirm('delete this order?');" class="delete-btn">Supprimer</a>
         </form>
      </div>
      <?php
         }
